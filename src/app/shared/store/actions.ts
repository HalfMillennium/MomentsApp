...
export const registerEmailSuccess = createAction('[Auth Dialog Component] Register Email Success', props<{userCredential: UserCredential, displayName?: string, photoURL?: string}>());
...
export const updateUserBasics = createAction('[Auth Dialog Component] Update Users Basics Success', props<{userCredential: UserCredential, displayName: string}>());
