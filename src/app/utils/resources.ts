...
export const MOCK_BUILDINGS: ApartmentBuilding[] = [
  {
    ...
    images: [
      {
        url: 'https://images.theconversation.com/files/465656/original/file-20220527-17-9sel6k.jpg?ixlib=rb-1.1.0&q=20&auto=format&w=320&fit=clip&dpr=2&usm=12&cs=strip',
        alt: "Photo of 'Kenyorgi' dog",
      },
    ],
  },
  {
    ...
    images: [
      {
        url: 'https://wgmimedia.com/wp-content/uploads/2023/04/Google-Magi.jpg',
